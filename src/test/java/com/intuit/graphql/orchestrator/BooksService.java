...
public class BooksService implements ServiceProvider {
  ...
  public BooksService(final BiConsumer<ExecutionInput, GraphQLContext> function) {
    this.books = createBooks();
  ...
  private Map<String, Object> createBooks() {
    ...
    b3.put("author", ImmutableMap.of(
        "id", "author-3",
        "lastName", "AuthorThree",
        "petId", "pet-3"
    ));
