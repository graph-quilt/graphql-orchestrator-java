...
public class FederationUtilsTest {
    ...
    public void npeFromNullSourceGraphWhenCheckingEmptyFieldSet() {
        ...
        checkFieldSetValidity(null, typeDefinitionMock, fieldSet, FEDERATION_KEY_DIRECTIVE);
    }
    ...
    public void npeFromNullTypeDefWhenCheckingEmptyFieldSet() {
        ...
        checkFieldSetValidity(sourceGraphMock, null, fieldSet, FEDERATION_KEY_DIRECTIVE);
    }
    ...
    public void EmptyFieldsExceptionWhenCheckingEmptyFieldSetWithEmptyFieldSet() {
        ...
        checkFieldSetValidity(sourceGraphMock, typeDefinitionMock, fieldSet, FEDERATION_KEY_DIRECTIVE);
    }
    ...
    public void EmptyFieldsExceptionWhenCheckingEmptyFieldSetWithNullFieldSet() {
        ...
        checkFieldSetValidity(sourceGraphMock, typeDefinitionMock, null, FEDERATION_KEY_DIRECTIVE);
    }
    ...
    public void invalidFieldReferenceExceptionWithFieldSetWithInvalidChildren() {
        ...
        checkFieldSetValidity(sourceGraphMock, testDefinitionMock, fieldSet, FEDERATION_KEY_DIRECTIVE);
    }
